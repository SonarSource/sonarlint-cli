...
IF EXIST "%SONARLINT_HOME%\lib\sonarlint-cli-${project.version}.jar" goto run
...
%JAVA_EXEC% -Djava.awt.headless=true %SONARLINT_OPTS% -cp "%SONARLINT_HOME%\lib\sonarlint-cli-${project.version}.jar" "-Dsonarlint.home=%SONARLINT_HOME%" "-Dproject.home=%PROJECT_HOME%" org.sonarlint.cli.Main %*
